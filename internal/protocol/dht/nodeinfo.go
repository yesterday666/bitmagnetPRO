...
// Scrub filters out nodes that don't have valid IPv4 addresses.
// This is needed for dual-stack DHT where IPv6 nodes may get into the
// CompactIPv4NodeInfo and cause marshal failures.
